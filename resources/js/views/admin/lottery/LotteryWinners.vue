  ...
  <div class="main-content">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Lottery Winners</li>
      </ol>
    </div>
    <div class="row">
      <div class="col-sm-12">
...
export default {
  ...
  methods: {
    ...
    async getLotteryWinners ({ page, filter, sort }) {
      try {
        const response = await axios.get(`/api/admin/lottery/getWinnersList?page=${page}&filter=${filter}&sortcol=${sort.fieldName}&sort=${sort.order}`)
